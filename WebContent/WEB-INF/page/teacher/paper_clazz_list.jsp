  ...
  <body class="app sidebar-mini rtl">
    <main class="app-content">
      ...
      <div class="row">
          ...
          <div class="tile">
            <div class="tile-body">
              <form class="row" method="post" action="${basePath }teacher/ChoosePaperClazzServlet?flag=1&paperId=${paperId }">
                ...
                <div class="form-group col-md-4 align-self-end">
                  ...
                  <button class="btn btn-primary" type="button" onclick="toSubmit()"><i class="fa fa-fw fa-lg fa-plus-circle"></i>添加</button>
                </div>
              </form>
            </div>
          </div>
    ...
    <script type="text/javascript">
      function toSubmit(){
    	  Id = $('#paperId').val()
    	  $.ajax({
    		  url:'${basePath}manager/SelectPaperClazzServlet?paperId='+Id,
    		  type:'post',
    		  ...
    		  success:function(data){
    			  if(data=='ok'){
    				  alert("设置成功");
    				  window.location.href='${basePath }teacher/ChoosePaperClazzServlet';
    			  }else{
    				  alert("系统异常，请稍后再试");
    			  }
    		  }
